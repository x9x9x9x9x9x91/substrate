...
pub(crate) const SEED_FILES: &[SeedFile] = &[
    SeedFile {
        ...
        revisions: &[
            ...
            include_str!("../seed/revisions/agents-v0.28a.md"),
            include_str!("../seed/revisions/agents-v0.29.md"),
            include_str!("../seed/revisions/agents-v0.29a.md"),
...
pub(crate) const SETTINGS_BODY_REVISIONS: &[&str] = &[
    ...
    include_str!("../seed/revisions/settings-body-v0.29.md"),
    include_str!("../seed/revisions/settings-body-v0.29a.md"),
    SETTINGS_BODY,
];
...
mod tests {
    ...
    fn seed_revisions_stay_in_lockstep_with_the_seed_text() {
        ...
        const PINNED_SEED_REVISIONS: &[(&str, &[u64])] = &[
            (
                ...
                &[
                    ...
                    0x1d22_e94b_efbd_3ca1,
                    0xc38e_0bea_692d_b271,
                    0x699d_4886_6530_e2c0,
                ],
            ),
        ...
        const PINNED_SETTINGS_BODY_REVISIONS: &[u64] = &[
            ...
            0x3f12_2005_7e06_ed1c,
            0x0670_0f8d_0e46_e205,
        ];

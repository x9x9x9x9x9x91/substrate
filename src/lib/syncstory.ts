/* Sync dashboard row copy: the surface's age voice ("35m", "2h 14m", "1d 2h",
   "never") and, since SUB-579, the problem leg's finding as one sentence.
   ...
   reuses it (SUB-699) so both surfaces spell ages the same way. */
...
/** The two largest units with zero remainders dropped, matching fmtWindow's
    convention (SUB-327) in this surface's compact spelling: "35m", "9h",
    "2h 14m", "1d 2h", "2d". */
...
/** A problem leg's whole story as one sentence fragment — "failed · 2 errors
    · tried 35m ago" (SUB-579 findings-as-sentence: it sits next to the leg

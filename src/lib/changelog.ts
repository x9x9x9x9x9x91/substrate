...
export const CHANGELOG: ChangelogRelease[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "Reach, in both directions: substrate:// links open the app from anywhere onto a note or a prefilled capture box; search sees into mounted folders; sheets gain a totals row, filtered sums, and column notifications that open the sheet at the row that fired; property kinds can ship as bundles inside the vault; dashboards compose on a grid; a settings dial picks the one locale every date renders in; and a glow dial with curated accent tones joins Settings.",
        kind: "new",
      },
      {
